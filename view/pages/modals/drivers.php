    ...
    <div class="modal-card-small">
        ...
        <div class="modal-body">
            <div class="driver-info-layout">
                <img id="driver-options-image" src="media/images/foo.jpeg" alt="foo">
...
<div class="modal hidden" id="driver-fire-confirm">
    <div class="modal-card-small">
        <div class="modal-header">
            <h2><?=$l_arr["newdriver"]["txt_7"];?></h2>
            <button><i class="fas fa-times"></i></button>
        </div>
        <div class="modal-body">
            <button class="button button-danger" id="driver-fire-yes"><i class="fas fa-edit"></i><?=$l_arr["newdriver"]["txt_8"];?></button>
