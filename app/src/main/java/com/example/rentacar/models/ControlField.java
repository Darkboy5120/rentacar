...
public abstract class ControlField {
    ...
    private void setHelpVisibility(View v, int value) {
        v.findViewById(this.help_id).setVisibility(value);
    }
    private void setLogVisibility(View v, int value) {
    ...
    public String getValue(View v) {
        return ((EditText) v.findViewById(this.et_id)).getText().toString();
    }
}
