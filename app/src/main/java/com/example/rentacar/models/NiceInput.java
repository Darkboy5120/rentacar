...
public class NiceInput extends ControlField {
    ...
    public NiceInput(String et_type, int label_id, int et_id, int help_id, int log_id, String regex,
            ...
            et_view.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if(event.getAction() == MotionEvent.ACTION_UP) {
                        if(event.getRawX() >= (((EditText) view.findViewById(et_id)).getRight() - ((EditText) view
                                .findViewById(et_id)).getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
                            // your action here
    ...
    public void togglePasswordMask(View v) {
        ...
        EditText et_view = v.findViewById(this.et_id);
    ...
    public boolean isEmpty(View v) {
        return ((EditText) v.findViewById(this.et_id)).getText().length() <= 0;
    }
}
